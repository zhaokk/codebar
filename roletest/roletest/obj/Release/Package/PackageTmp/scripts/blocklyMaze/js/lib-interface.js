...
BlocklyInterface.importInterpreter = function() {
  ...
  script.setAttribute('src', '../scripts/blocklyMaze/third-party/JS-Interpreter/compiled.js');
...
BlocklyInterface.importPrettify = function() {
  //<link rel="stylesheet" type="text/css" href="../scripts/blocklyMaze/common/prettify.css">
  //<script type="text/javascript" src="../scripts/blocklyMaze/common/prettify.js"></script>
  var link = document.createElement('link');
  link.setAttribute('rel', 'stylesheet');
  link.setAttribute('type', 'text/css');
  link.setAttribute('href', '../scripts/blocklyMaze/common/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('type', 'text/javascript');
  script.setAttribute('src', '../scripts/blocklyMaze/common/prettify.js');
  document.head.appendChild(script);
};
