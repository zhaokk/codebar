...
function addAccessors($scope) {
    $scope.swim = function () {
        ...
        if (activeGroup) {
            ...
            activeObject.animate('angle', '-=5', { onChange: canvas.renderAll.bind(canvas) });
            //activeObject.animate('angle', '+=5', { onChange: canvas.renderAll.bind(canvas) });
            activeObject.animate('left', '-=200', { onChange: canvas.renderAll.bind(canvas) });
                
        }
    }
    $scope.swim1 = function () {
    ...
    function addImage(imageName, minScale, maxScale) {
        ...
        fabric.Image.fromURL('../Content/lifecycle/' + imageName, function (image) {
    ...
    $scope.addImageForDrop = function () {
        addImageForDrop();

    }
    $scope.addLifeCycle = function (phase) {

        var phaseNum = phase;
        switch (phase) {
            case 3:
                fabric.Image.fromURL('../Content/lifecycle/arrow.png', function (image) {
    ...
    $scope.addImage1 = function () {
        addImage('Egg.png', 1, 1);
    };
    $scope.addImageReeds = function () {
        addImage('reeds.png', 0.7, 0.7);
    };
    $scope.addImageLilypad = function () {
        addImage('lotus.png', 0.7, 0.7);
    };
    $scope.addImage2 = function () {
        addImage('tadpole.png', 0.7, 0.7);
    };

    $scope.addImage3 = function () {
        addImage('frog.png', 0.7, 0.7);
    };
    $scope.addCR1 = function () {
        addImage('eggCase.png', 0.3, 0.5);
    };
    $scope.addCR2 = function () {
        addImage('NymphCR.png', 0.3, 0.5);
    };
    $scope.addCR3 = function () {
        addImage('adultcr.png', 0.3, 0.5);
    };
    $scope.addImageArrow = function () {
        addImage('arrow.png', 0.1, 0.1);
    };
    $scope.addImageRedArrow = function () {
        addImage('arrowRed.png', 0.1, 0.1);
    };
    ...
    var pattern = new fabric.Pattern({
        source: '/Content/lifecycle/escheresque.png',
        repeat: 'repeat'
    });
    ...
    function initImagePatternBrush() {
        var img = new Image();
        img.src = '../Content/lifecycle/honey_im_subtle.png';
...
function addImageForDrop(basecode) {
    var coord = getRandomLeftTop();
    var newimage = new Image();
    newimage.src = basecode
